...
public class CollectorsExercise1 {
    ...
    public void testPersonToHisLongestJobDuration() {
        ...
        Map<Person, Integer> collected = getEmployees()
                ...
                .collect(
                        Collectors.toMap(
                                Employee::getPerson, employee -> employee.getJobHistory()
                                        .stream()
                                        .mapToInt(JobHistoryEntry::getDuration)
                                        .max()
                                        .orElseThrow(NoSuchElementException::new)));//getEmployees()
                        ...
                        HashMap::new, (map, employee)
                                ...
                                .forEach(d -> {
                                    map.put(
                                            ...
                                            map.getOrDefault(employee.getPerson().getFirstName(), 0) + d
                                    );
                                    map.put(
                                            employee.getPerson().getLastName(),
                                            map.getOrDefault(employee.getPerson().getLastName(), 0) + d
                                    );
                                }),
                        HashMap::putAll);
