...
public class LambdaExercise {
    ...
    public void combineFunctions() {
        ...
        final Function<Person, Integer> getPersonNameLength1 = person -> person.getFirstName().length();
    ...
    private <T, R> Predicate<T> combine(Function<T, R> f, Predicate<R> p) {
        return  t -> p.test(f.apply(t));// TODO
    ...
    public void methodReference() {
        ...
        final Predicate<String> isJohnString = Objects::nonNull; // TODO using method reference check that "John" equals string parameter
