...
public class StreamsExercise {
    ...
    public void indexPersonsByEmployer2() {
        ...
        final Map<String, List<Person>> index = employees.stream()
            ...
            .collect(Collectors.groupingBy(
                    PersonEmployer::getEmployer, Collectors.mapping(PersonEmployer::getPerson, Collectors.toList())));
    ...
    public void getSumPersonDuration() {
        ...
        final Map<Person, Integer> personDuration = employees.stream()
            .map(employee -> sumAllPersonDurations(employee))
                ...
                .flatMap(employee -> employee.getJobHistory().stream()
                      .map(jobHistoryEntry -> new PersonPositionDuration(
                        ...
                        Collectors.collectingAndThen(Collectors.maxBy(
                                ...
                                personPositionDuration -> personPositionDuration.get())));
