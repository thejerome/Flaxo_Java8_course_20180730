...
public class Mapping {
    ...
    public void mapping() {
        ...
        final List<Employee> mappedEmployees =
                new MapHelper<>(employees)
                        ...
                        .map(employee -> employee.withJobHistory(replaceCase(employee.getJobHistory())))
                        .getList();
                        /*
    ...
    private List<JobHistoryEntry> addOneYear(List<JobHistoryEntry> jobHistoryEntries){
        return new MapHelper<>(jobHistoryEntries)
                .map(job -> job.withDuration(job.getDuration()+1))
                .getList();
    }

    private List<JobHistoryEntry> replaceCase(List<JobHistoryEntry> jobHistoryEntries){
        return new MapHelper<>(jobHistoryEntries)
                .map(jobHistoryEntry -> "qa".equals(jobHistoryEntry.getPosition())
