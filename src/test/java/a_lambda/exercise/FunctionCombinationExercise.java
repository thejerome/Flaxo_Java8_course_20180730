...
public class FunctionCombinationExercise {
    ...
    private static <T> Predicate<T> negate(Predicate<T> test) {
    ...
    public void personHasNotEmptyLastNameAndFirstName2() {
        ...
        final Predicate<Person> validateFirstName = negate(hasEmptyFirstName); // TODO use FunctionCombinationExercise::negate  - HOW?
